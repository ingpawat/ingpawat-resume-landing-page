            ...
            <div className="respondSet ">
                ...
                <div className="aboutMeContentBox w-[100%] h-[45%] flex justify-center items-center flex-row   ">
                    ...
                    <div className="technologyFamiliar  w-[40%] h-[100%] text-white  ">
                        <p className="text-[28px] mt-9 mb-0 flex justify-center items-center flex-row underline  underline-offset-8 ">Familiar with Technology </p><br />
                        ...
                        <div className="flex justify-center items-center flex-row  mt-1 bg-[#6e7878]">
                            ...
                            <a className="axios m-2 mr-0" href="https://axios-http.com/docs/intro">
                                <img alt="axios" width="80" height="80" src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/Axios_logo_%282020%29.svg/2560px-Axios_logo_%282020%29.svg.png" /></a>
                            <a className="redux m-0" href="https://redux.js.org/introduction/getting-started">
                                <img alt="redux" width="90" height="90" src="https://upload.wikimedia.org/wikipedia/commons/4/49/Redux.png" /></a>
                        </div>
                        ...
                        <div className="flex justify-center items-center flex-row h-[80px] mt-1 bg-[#6e7878]">
                            ...
                            <a className="srapi m-2 ml-3" href="https://docs.strapi.io/developer-docs/latest/getting-started/introduction.html">
                                <img alt="srapi" width="40" height="40" src="https://seeklogo.com/images/S/strapi-logo-3551DD3743-seeklogo.com.png" /></a>
                        </div>
                        ...
                        <div className="flex justify-center items-center flex-row  h-[80px]  mt-1 bg-[#6e7878]">
                            ...
                            <a className="hotjar ml-2" href="https://www.hotjar.com/">
                                <img alt="hotjar" width="45" height="45" src="https://leadgenapp.io/wp-content/uploads/2022/03/517f022479163259d192181405b3cddc.png" /></a>

                            <a className="google" href="https://analytics.google.com/analytics/web/provision/#/provision">
                                <img alt="google" width="80" height="80" src="https://logos-world.net/wp-content/uploads/2021/02/Google-Analytics-Logo.png" /></a>

                            <a className="meta m-0" href="https://developers.facebook.com/docs/meta-pixel/get-started">
                                <img alt="meta" width="80" height="80" src="https://pnggrid.com/wp-content/uploads/2021/11/Meta-1024x576.png" /></a>
                        </div>
                ...
                <hr />
                {/* contact */}
                <div id="2" className="contact w-[100%] h-[25%] flex justify-start items-center flex-col z-0 relative ">
                    ...
                    <div className="contact-logo w-[85%] h-[100%] mt-8 flex justify-center items-start flex-row   ">
                        ...
                        <div className="m-[7%] mt-0 text-white ">
                            <div className="flex justify-center"><a href="https://www.linkedin.com/in/ingpawat-khemngam-12a4b11ab/">
                                <img className="w-[auto] h-[60px] m-0 p-0 flex justify-center" src="https://www.svgrepo.com/show/204944/linkedin.svg" /></a>
                            </div>
                        ...
                        <div className="m-[7%] mt-[-5px] text-white ">
                            <div className="flex justify-center"><a href="https://github.com/ingpawat">
                                <img className="w-[auto] h-[70px] m-0 p-0 flex justify-center" src="https://www.svgrepo.com/show/360450/github.svg" /></a>
                            </div>
                            <br /> 
                            <p> Github </p>
                        ...
                        <div className="m-[7%] mt-0 text-white z-0 relative ">
                            <button className="flex justify-center"
                                ...
                                <img className="w-[auto] h-[65px] m-0 p-0 flex justify-center" src="https://www.svgrepo.com/show/13657/email.svg" />
                            </button>
                        ...
                        <div className="m-[7%] mt-0 text-white z-0 relative ">
                            <button className="flex justify-center"
                                ...
                                <img className="w-[auto] h-[67px] m-0 p-0 flex justify-center" src="https://cdn-icons-png.flaticon.com/512/25/25377.png" /></a>
                            </button>
